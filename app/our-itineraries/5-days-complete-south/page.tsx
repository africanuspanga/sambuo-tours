...
export const metadata: Metadata = {
  title: "5 Days Mikumi, Selous & Ruaha Safari | KiliSafari",
  description:
    ...
    <>
      ...
      <div className="min-h-screen bg-background">
        ...
        <section className="relative h-[400px] md:h-[500px]">
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center text-white">
            <div className="container mx-auto px-4 text-center">
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-4">5 Days: Mikumi, Selous & Ruaha</h1>
              <p className="text-xl md:text-2xl font-semibold text-brand-orange">The Complete Southern Circuit</p>
              <div className="mt-4 flex items-center justify-center gap-3">
                <span className="bg-brand-orange px-6 py-2 rounded-full font-bold">5 Days / 4 Nights</span>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto">
              <div className="flex items-center gap-3 justify-center">
                ...
                <div>
                  ...
                  <p className="text-xl font-bold text-brand-dark">$2,218 pp</p>
                </div>
              </div>
              <div className="flex items-center gap-3 justify-center">
                ...
                <div>
                  ...
                  <p className="text-xl font-bold text-brand-dark">5 Days / 4 Nights</p>
                </div>
              </div>
              <div className="flex items-center gap-3 justify-center">
                ...
                <table className="w-full">
                  ...
                  <tbody>
                    <tr className="border-b">
                      ...
                      <td className="py-4 px-6 text-right font-bold text-brand-orange">$2,218 (Total Trip)</td>
                    </tr>
                    <tr className="border-b bg-gray-50">
                      <td className="py-4 px-6">2 People</td>
                      <td className="py-4 px-6 text-right font-bold">$1,346 pp</td>
                    </tr>
                    <tr className="border-b">
                      <td className="py-4 px-6">3 People</td>
                      <td className="py-4 px-6 text-right font-bold">$1,125 pp</td>
                    </tr>
                    <tr className="border-b bg-gray-50">
                      <td className="py-4 px-6">4 People</td>
                      <td className="py-4 px-6 text-right font-bold">$979 pp</td>
                    </tr>
                    <tr>
                      <td className="py-4 px-6">5-10 People</td>
                      <td className="py-4 px-6 text-right font-bold text-brand-green">$965 pp (Best Value!)</td>
                    </tr>
                  </tbody>
                </table>
              </div>
        ...
        <section className="py-16 bg-brand-dark text-white">
          <div className="container mx-auto px-4 text-center">
            <h2 className="text-3xl md:text-4xl font-bold mb-6">Experience All Three Southern Parks!</h2>
