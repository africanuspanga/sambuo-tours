...
export const metadata: Metadata = {
  title: "6 Days Ultimate Southern Circuit Safari | KiliSafari",
  description:
        ...
        <section className="relative h-[400px] md:h-[500px]">
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center text-white">
            <div className="container mx-auto px-4 text-center">
              ...
              <p className="text-xl md:text-2xl font-semibold text-brand-orange">
                Mikumi, Selous & Ruaha - The Complete Experience
              </p>
              <div className="mt-4 flex items-center justify-center gap-3">
                <span className="bg-brand-orange px-6 py-2 rounded-full font-bold">6 Days / 5 Nights</span>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto">
              <div className="flex items-center gap-3 justify-center">
                ...
                <div>
                  ...
                  <p className="text-xl font-bold text-brand-dark">$2,499 pp</p>
                </div>
              </div>
              <div className="flex items-center gap-3 justify-center">
                ...
                <div>
                  ...
                  <p className="text-xl font-bold text-brand-dark">6 Days / 5 Nights</p>
                </div>
              </div>
              <div className="flex items-center gap-3 justify-center">
                ...
                <table className="w-full">
                  ...
                  <tbody>
                    <tr className="border-b">
                      ...
                      <td className="py-4 px-6 text-right font-bold text-brand-orange">$2,499 (Total Trip)</td>
                    </tr>
                    ...
                    <tr>
                      ...
                      <td className="py-4 px-6 text-right font-bold text-brand-green">$1,085 pp (Best Value!)</td>
                    </tr>
                  </tbody>
                </table>
              </div>
