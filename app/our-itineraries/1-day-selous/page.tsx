...
export const metadata: Metadata = {
  title: "1 Day Selous (Nyerere NP) Safari | KiliSafari",
  description:
        ...
        <section className="relative h-[400px] md:h-[500px]">
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center text-white">
            <div className="container mx-auto px-4 text-center">
              ...
              <p className="text-xl md:text-2xl font-semibold text-brand-orange">The Ultimate Day Trip</p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto">
              <div className="flex items-center gap-3 justify-center">
                ...
                <div>
                  ...
                  <p className="text-xl font-bold text-brand-dark">$720 pp</p>
                </div>
              </div>
              <div className="flex items-center gap-3 justify-center">
                ...
                <div>
                  ...
                  <p className="text-xl font-bold text-brand-dark">1 Day</p>
                </div>
              </div>
              <div className="flex items-center gap-3 justify-center">
                ...
                <table className="w-full">
                  ...
                  <tbody>
                    <tr className="border-b">
                      ...
                      <td className="py-4 px-6 text-right font-bold text-brand-orange">$720 (Total Trip)</td>
                    </tr>
                    <tr className="border-b bg-gray-50">
                      <td className="py-4 px-6">2 People</td>
                      <td className="py-4 px-6 text-right font-bold">$478 pp</td>
                    </tr>
                    <tr className="border-b">
                      <td className="py-4 px-6">3 People</td>
                      <td className="py-4 px-6 text-right font-bold">$425 pp</td>
                    </tr>
                    <tr className="border-b bg-gray-50">
                      <td className="py-4 px-6">4 People</td>
                      <td className="py-4 px-6 text-right font-bold">$290 pp</td>
                    </tr>
                    <tr>
                      <td className="py-4 px-6">5-10 People</td>
                      <td className="py-4 px-6 text-right font-bold text-brand-green">$375 pp (Best Value!)</td>
                    </tr>
                  </tbody>
                </table>
              </div>
                  ...
                  <div className="p-6">
                    <div className="space-y-4">
                      <div className="flex gap-4">
                        <div className="flex-shrink-0 w-24 font-bold text-brand-dark">03:00 AM</div>
                        <div>
                          <h4 className="font-bold text-brand-dark mb-2">Very Early Morning Pickup</h4>
                      ...
                      <div className="flex gap-4">
                        <div className="flex-shrink-0 w-24 font-bold text-brand-dark">08:30 AM</div>
                        <div>
                          <h4 className="font-bold text-brand-dark mb-2">Arrival & Morning Game Drive</h4>
                          <p className="text-gray-700">
                      ...
                      <div className="flex gap-4">
                        <div className="flex-shrink-0 w-24 font-bold text-brand-dark">01:00 PM</div>
                        <div>
                          <h4 className="font-bold text-brand-dark mb-2">Picnic Lunch</h4>
                          <p className="text-gray-700">
                      ...
                      <div className="flex gap-4">
                        <div className="flex-shrink-0 w-24 font-bold text-brand-dark">02:00 PM</div>
                        <div>
                          <h4 className="font-bold text-brand-dark mb-2">Boat Safari on the Rufiji River</h4>
                          <p className="text-gray-700">
                      ...
                      <div className="flex gap-4">
                        <div className="flex-shrink-0 w-24 font-bold text-brand-dark">04:30 PM</div>
                        <div>
                          <h4 className="font-bold text-brand-dark mb-2">Departure to Dar</h4>
                          <p className="text-gray-700">Exit the park and begin the long drive back to Dar es Salaam.</p>
                        </div>
                      </div>

                      <div className="flex gap-4">
                        <div className="flex-shrink-0 w-24 font-bold text-brand-dark">10:00 PM</div>
                        <div>
                          <h4 className="font-bold text-brand-dark mb-2">Late Evening Drop-off</h4>
