...
export const metadata: Metadata = {
  title: "3 Days Mikumi & Selous Safari | KiliSafari",
  description:
        ...
        <section className="relative h-[400px] md:h-[500px]">
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center text-white">
            <div className="container mx-auto px-4 text-center">
              ...
              <p className="text-xl md:text-2xl font-semibold text-brand-orange">Southern Circuit Explorer</p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto">
              <div className="flex items-center gap-3 justify-center">
                ...
                <div>
                  ...
                  <p className="text-xl font-bold text-brand-dark">$1,210 pp</p>
                </div>
              </div>
              <div className="flex items-center gap-3 justify-center">
                ...
                <div>
                  ...
                  <p className="text-xl font-bold text-brand-dark">3 Days / 2 Nights</p>
                </div>
              </div>
              <div className="flex items-center gap-3 justify-center">
                ...
                <table className="w-full">
                  ...
                  <tbody>
                    <tr className="border-b">
                      ...
                      <td className="py-4 px-6 text-right font-bold text-brand-orange">$1,210 (Total Trip)</td>
                    </tr>
                    <tr className="border-b bg-gray-50">
                      <td className="py-4 px-6">2 People</td>
                      <td className="py-4 px-6 text-right font-bold">$742 pp</td>
                    </tr>
                    <tr className="border-b">
                      <td className="py-4 px-6">3 People</td>
                      <td className="py-4 px-6 text-right font-bold">$570 pp</td>
                    </tr>
                    <tr className="border-b bg-gray-50">
                      <td className="py-4 px-6">4 People</td>
                      <td className="py-4 px-6 text-right font-bold">$504 pp</td>
                    </tr>
                    <tr>
                      <td className="py-4 px-6">5-10 People</td>
                      <td className="py-4 px-6 text-right font-bold text-brand-green">$495 pp (Best Value!)</td>
                    </tr>
                  </tbody>
                </table>
              </div>
