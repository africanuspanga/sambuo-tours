            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto">
              <div className="flex items-center gap-3 justify-center">
                ...
                <div>
                  ...
                  <p className="text-xl font-bold text-brand-chocolate">$1,210 pp</p>
                </div>
              </div>
              <div className="flex items-center gap-3 justify-center">
                ...
                <table className="w-full">
                  ...
                  <tbody>
                    <tr className="border-b">
                      ...
                      <td className="py-4 px-6 text-right font-bold text-brand-gold">$1,210 (Total Trip)</td>
                    </tr>
                    ...
                    <tr>
                      ...
                      <td className="py-4 px-6 text-right font-bold text-brand-ocean">$495 pp (Best Value!)</td>
                    </tr>
                  </tbody>
                </table>
              </div>
