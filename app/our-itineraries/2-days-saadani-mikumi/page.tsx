...
export const metadata: Metadata = {
  title: "2 Days Saadani & Mikumi Safari | KiliSafari",
  description:
        ...
        <div className="bg-brand-dark text-white py-6">
          <div className="container mx-auto px-4">
            <div className="flex flex-wrap justify-center gap-8 text-center">
              <div>
                <div className="text-3xl font-bold text-brand-orange">$1,085</div>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <section className="mb-16">
              ...
              <div className="space-y-12">
                {/* Day 1 */}
                <div>
                  <h3 className="text-2xl font-bold text-brand-orange mb-6 flex items-center gap-3">
                    <span className="bg-brand-orange text-white rounded-full w-10 h-10 flex items-center justify-center text-lg">
                      1
                    </span>
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="bg-white p-6 rounded-lg shadow-md border-l-4 border-brand-green">
                      <div className="flex items-start gap-4">
                        ...
                        <div>
                          <h4 className="text-lg font-bold text-brand-dark mb-2">Arrival & Check-in at Lodge</h4>
                          <p className="text-gray-700">
                    ...
                    <div className="bg-white p-6 rounded-lg shadow-md border-l-4 border-brand-orange">
                      <div className="flex items-start gap-4">
                        ...
                        <div>
                          <h4 className="text-lg font-bold text-brand-dark mb-2">Afternoon Wami River Boat Safari</h4>
                          <p className="text-gray-700">
                    ...
                    <div className="bg-white p-6 rounded-lg shadow-md border-l-4 border-brand-green">
                      <div className="flex items-start gap-4">
                        ...
                        <div>
                          <h4 className="text-lg font-bold text-brand-dark mb-2">Short Coastal Game Drive</h4>
                          <p className="text-gray-700">
                    ...
                    <div className="bg-white p-6 rounded-lg shadow-md border-l-4 border-brand-orange">
                      <div className="flex items-start gap-4">
                        ...
                        <div>
                          <h4 className="text-lg font-bold text-brand-dark mb-2">Dinner & Overnight</h4>
                          <p className="text-gray-700">
                  ...
                  <div className="space-y-6">
                    <div className="bg-white p-6 rounded-lg shadow-md border-l-4 border-brand-green">
                      <div className="flex items-start gap-4">
                        ...
                        <div>
                          <h4 className="text-lg font-bold text-brand-dark mb-2">Breakfast & Very Early Departure</h4>
                          <p className="text-gray-700">
                    ...
                    <div className="bg-white p-6 rounded-lg shadow-md border-l-4 border-brand-orange">
                      <div className="flex items-start gap-4">
                        ...
                        <div>
                          <h4 className="text-lg font-bold text-brand-dark mb-2">Picnic Lunch En-Route</h4>
                          <p className="text-gray-700">
                    ...
                    <div className="bg-white p-6 rounded-lg shadow-md border-l-4 border-brand-green">
                      <div className="flex items-start gap-4">
                        ...
                        <div>
                          <h4 className="text-lg font-bold text-brand-dark mb-2">Arrival at Mikumi & Game Drive</h4>
                          <p className="text-gray-700">
                    ...
                    <div className="bg-white p-6 rounded-lg shadow-md border-l-4 border-brand-orange">
                      <div className="flex items-start gap-4">
                        ...
                        <div>
                          <h4 className="text-lg font-bold text-brand-dark mb-2">Departure to Dar es Salaam</h4>
                          <p className="text-gray-700">
                    ...
                    <div className="bg-white p-6 rounded-lg shadow-md border-l-4 border-brand-green">
                      <div className="flex items-start gap-4">
                        ...
                        <div>
                          <h4 className="text-lg font-bold text-brand-dark mb-2">Late Drop-off in Dar es Salaam</h4>
                          <p className="text-gray-700">
                ...
                <table className="w-full">
                  ...
                  <tbody className="divide-y divide-gray-200">
                    <tr className="hover:bg-gray-50">
                      ...
                      <td className="py-4 px-6 text-right text-brand-orange font-bold text-lg">$1,085</td>
                    </tr>
                    <tr className="hover:bg-gray-50">
                      <td className="py-4 px-6 font-semibold">2 People</td>
                      <td className="py-4 px-6 text-right text-brand-orange font-bold text-lg">$556</td>
                    </tr>
                    <tr className="hover:bg-gray-50">
                      <td className="py-4 px-6 font-semibold">3 People</td>
                      <td className="py-4 px-6 text-right text-brand-orange font-bold text-lg">$470</td>
                    </tr>
                    <tr className="hover:bg-gray-50">
                      <td className="py-4 px-6 font-semibold">4 People</td>
                      <td className="py-4 px-6 text-right text-brand-orange font-bold text-lg">$430</td>
                    </tr>
                    <tr className="hover:bg-gray-50 bg-brand-orange/5">
                      <td className="py-4 px-6 font-semibold">5-10 People</td>
                      <td className="py-4 px-6 text-right text-brand-orange font-bold text-lg">$412</td>
                    </tr>
                  </tbody>
                </table>
              </div>
              ...
              <div className="grid md:grid-cols-2 gap-8">
                <div className="bg-green-50 p-6 rounded-lg">
                  ...
                  <ul className="space-y-2 text-gray-700">
                    ...
                    <li className="flex items-start gap-2">
                      <span className="text-brand-green mt-1">✓</span>1 night mid-range accommodation
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="text-brand-green mt-1">✓</span>
