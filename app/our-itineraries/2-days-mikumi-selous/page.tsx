...
export const metadata: Metadata = {
  title: `2 Days Mikumi & Selous Safari | Sambuo Tours`,
  description:
    ...
    <>
      ...
      <div className="min-h-screen bg-brand-cream">
        ...
        <section className="relative h-[400px] md:h-[500px]">
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center text-white">
            <div className="container mx-auto px-4 text-center">
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-serif font-bold mb-4">2 Days Mikumi NP & Selous Safari</h1>
              <p className="text-xl md:text-2xl font-semibold text-brand-gold">The Two-Park Taster</p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-3xl mx-auto">
              <div className="flex items-center gap-3 justify-center">
                ...
                <div>
                  ...
                  <p className="text-xl font-serif font-bold text-brand-chocolate">2 Days / 1 Night</p>
                </div>
              </div>
              <div className="flex items-center gap-3 justify-center">
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto">
              ...
              <div className="space-y-6">
                ...
                <div className="bg-white rounded-2xl shadow-lg overflow-hidden">
                  <div className="bg-brand-gold text-white py-4 px-6">
                    <h3 className="text-2xl font-serif font-bold">Day 2: Mikumi to Selous & Boat Safari (B, L)</h3>
                  </div>
                  <div className="p-6">
        ...
        <section className="py-16 bg-brand-chocolate text-white">
          <div className="container mx-auto px-4 text-center">
            <h2 className="text-3xl md:text-4xl font-serif font-bold mb-6">Ready for Your Two-Park Adventure?</h2>
