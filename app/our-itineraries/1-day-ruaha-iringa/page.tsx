...
export const metadata: Metadata = {
  title: "1 Day Ruaha Safari from Iringa | KiliSafari",
  description:
        ...
        <div className="bg-brand-dark text-white py-6">
          <div className="container mx-auto px-4">
            <div className="flex flex-wrap justify-center gap-8 text-center">
              <div>
                <div className="text-3xl font-bold text-brand-orange">$566</div>
              ...
              <div className="space-y-8">
                <div className="bg-white p-6 rounded-lg shadow-md border-l-4 border-brand-orange">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <h3 className="text-xl font-bold text-brand-dark mb-2">Morning Pickup & Departure</h3>
                ...
                <div className="bg-white p-6 rounded-lg shadow-md border-l-4 border-brand-orange">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <h3 className="text-xl font-bold text-brand-dark mb-2">Picnic Lunch</h3>
                      <p className="text-gray-700">
                ...
                <div className="bg-white p-6 rounded-lg shadow-md border-l-4 border-brand-orange">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <h3 className="text-xl font-bold text-brand-dark mb-2">Departure to Iringa</h3>
                      <p className="text-gray-700">
                ...
                <div className="bg-white p-6 rounded-lg shadow-md border-l-4 border-brand-green">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <h3 className="text-xl font-bold text-brand-dark mb-2">Evening Drop-off</h3>
                ...
                <table className="w-full">
                  ...
                  <tbody className="divide-y divide-gray-200">
                    <tr className="hover:bg-gray-50">
                      ...
                      <td className="py-4 px-6 text-right text-brand-orange font-bold text-lg">$566</td>
                    </tr>
                    <tr className="hover:bg-gray-50">
                      <td className="py-4 px-6 font-semibold">2 People</td>
                      <td className="py-4 px-6 text-right text-brand-orange font-bold text-lg">$364</td>
                    </tr>
                    <tr className="hover:bg-gray-50">
                      <td className="py-4 px-6 font-semibold">3 People</td>
                      <td className="py-4 px-6 text-right text-brand-orange font-bold text-lg">$299</td>
                    </tr>
                    <tr className="hover:bg-gray-50">
                      <td className="py-4 px-6 font-semibold">4 People</td>
                      <td className="py-4 px-6 text-right text-brand-orange font-bold text-lg">$262</td>
                    </tr>
                    <tr className="hover:bg-gray-50 bg-brand-orange/5">
                      <td className="py-4 px-6 font-semibold">5-10 People</td>
                      <td className="py-4 px-6 text-right text-brand-orange font-bold text-lg">$258</td>
                    </tr>
                  </tbody>
                </table>
              </div>
