...
export const metadata = {
  title: "Lemosho Route (8 Days) - The Scenic Route | KiliSafari",
  description:
...
const pricing = [
  { pax: "1 Person", price: "$2,829" },
  { pax: "2 People", price: "$2,344 per person" },
  { pax: "3 People", price: "$2,182 per person" },
  { pax: "4+ People", price: "$2,102 per person" },
]
      ...
      <main>
        <section className="relative h-[60vh] md:h-[70vh] min-h-[500px] bg-gradient-to-br from-slate-900 to-slate-700 flex items-center justify-center">
          ...
          <div className="relative z-10 text-center px-4 max-w-4xl mx-auto mt-auto pb-8 md:pb-12">
            ...
            <p className="text-2xl md:text-3xl text-yellow-400 font-bold mb-4 drop-shadow-lg">The Scenic Route</p>
        ...
        <section className="py-12 md:py-16 bg-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="max-w-4xl mx-auto space-y-8">
              {itinerary.map((day) => (
                <div key={day.day} className="bg-gray-50 rounded-xl overflow-hidden border border-gray-200">
            ...
            <div className="max-w-3xl mx-auto">
              <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
                <div className="bg-gradient-to-r from-teal-700 to-teal-600 p-6 text-white">
                  <h3 className="text-2xl font-black mb-2">Lemosho Route</h3>
                  <p className="text-teal-100">8 Days / 7 Nights</p>
                </div>
                <div className="p-6 md:p-8">
