          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="max-w-3xl mx-auto">
              <div className="bg-brand-cream rounded-2xl shadow-xl overflow-hidden border border-gray-200">
                <div className="bg-gradient-to-r from-brand-chocolate to-amber-800 p-4 sm:p-6 text-white">
                    ...
                    {pricing.map((item, index) => (
                      ...
                      >
                        <div className="flex items-center gap-2 sm:gap-3">
                          <Users size={20} className="text-brand-chocolate" />
                          <span className="font-semibold text-gray-900 text-sm sm:text-base">{item.pax}</span>
                        </div>
                        <span className="text-lg sm:text-xl md:text-2xl font-black text-brand-chocolate">{item.price}</span>
                      </div>
                    ))}
                  </div>
                </div>
