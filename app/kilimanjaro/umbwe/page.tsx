...
import { ArrowLeft, Check, X, Users, AlertTriangle } from "lucide-react"
import Image from "next/image"

export const metadata = {
  title: "Umbwe Route (6 Days) - Double Whiskey Route | KiliSafari",
  description:
...
const pricing = [
  { pax: "1 Person", price: "$2,835" },
  { pax: "2 People", price: "$1,660 per person" },
  { pax: "3 People", price: "$1,502 per person" },
  { pax: "4+ People", price: "$1,452 per person" },
]
      ...
      <main>
        ...
        <section className="relative h-[50vh] sm:h-[60vh] md:h-[70vh] min-h-[400px] bg-gradient-to-br from-slate-900 to-slate-700 flex items-center justify-center">
          ...
          <div className="relative z-10 text-center px-4 max-w-4xl mx-auto">
            ...
            <p className="text-xl sm:text-2xl md:text-3xl text-yellow-400 font-bold mb-3 sm:mb-4 drop-shadow-lg">
                  ...
                  <div className="p-4 sm:p-6 md:p-8">
                    <div className="flex flex-col sm:flex-row sm:items-start gap-3 sm:gap-4">
                      ...
                      <div className="flex-1">
                        <h3 className="text-lg sm:text-xl md:text-2xl font-bold text-gray-900 mb-2">{day.title}</h3>

                        {/* Stats */}
                        <div className="flex flex-wrap gap-2 sm:gap-4 mb-3 text-sm text-gray-600">
                          <span className="bg-gray-100 px-2 py-1 rounded">{day.elevation}</span>
                          <span className="bg-gray-100 px-2 py-1 rounded">{day.distance}</span>
                          <span className="bg-gray-100 px-2 py-1 rounded">{day.time}</span>
                        </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="max-w-3xl mx-auto">
              <div className="bg-white rounded-2xl shadow-xl overflow-hidden border border-gray-200">
                <div className="bg-gradient-to-r from-amber-700 to-amber-600 p-4 sm:p-6 text-white">
                  <h3 className="text-xl sm:text-2xl font-black mb-1 sm:mb-2">Umbwe Route</h3>
                  <p className="text-amber-100">6 Days / 5 Nights</p>
                </div>
                <div className="p-4 sm:p-6 md:p-8">
                  <div className="space-y-3 sm:space-y-4">
                    {pricing.map((item, index) => (
                      <div
                        key={index}
                        className="flex items-center justify-between py-3 sm:py-4 border-b border-gray-200 last:border-0"
                      >
                        <div className="flex items-center gap-2 sm:gap-3">
                          <Users size={20} className="text-amber-700" />
                          <span className="font-semibold text-gray-900 text-sm sm:text-base">{item.pax}</span>
                        </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 max-w-6xl mx-auto">
              <div className="bg-green-50 rounded-2xl p-4 sm:p-6 md:p-8 border-2 border-green-200">
                <h3 className="text-xl sm:text-2xl font-black text-gray-900 mb-4 sm:mb-6 flex items-center gap-3">
        ...
        <section className="py-10 sm:py-12 md:py-16 bg-white">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="bg-blue-50 rounded-2xl p-4 sm:p-6 md:p-8 border-2 border-blue-200">
              <h3 className="text-xl sm:text-2xl font-black text-gray-900 mb-3 sm:mb-4">Health & Preparation</h3>
        ...
        <section className="py-10 sm:py-12 md:py-16 bg-gradient-to-br from-slate-900 to-slate-800 text-white">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <BookingModal
              trigger={
                <button className="inline-flex items-center justify-center rounded-md text-base sm:text-lg font-bold px-6 sm:px-8 py-3 sm:py-4 transition-all hover:scale-105 bg-yellow-500 text-gray-900 hover:bg-yellow-400">
                  Book Now
                </button>
              }
