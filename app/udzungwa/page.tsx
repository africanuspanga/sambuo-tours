...
export const metadata = {
  title: `Udzungwa Mountains National Park - Waterfalls & Hiking | ${company.shortName}`,
  description:
          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="mt-8 grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="bg-brand-cream border border-gray-200 rounded-lg p-6">
                <h4 className="font-bold text-brand-chocolate mb-2">Half Day</h4>
                <p className="text-sm text-gray-600">Sanje Waterfall trail - 4 hours round trip</p>
              </div>
              <div className="bg-brand-cream border border-gray-200 rounded-lg p-6">
                <h4 className="font-bold text-brand-chocolate mb-2">Full Day</h4>
                <p className="text-sm text-gray-600">Extended forest trails with primate viewing</p>
              </div>
              <div className="bg-brand-cream border border-gray-200 rounded-lg p-6">
                <h4 className="font-bold text-brand-chocolate mb-2">Multi-Day</h4>
